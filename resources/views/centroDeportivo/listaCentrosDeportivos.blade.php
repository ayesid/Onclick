    ...
    <div class="container py-5">
      <div class="row text-center py-3">
        <div class="col-lg-6 m-auto">
          ...
          <p>¡No te compliques la vida! ON CLICK te pone a un click de distancia de tu cancha sintética preferida. Revisa disponibilidad, reserva y abona desde donde te encuentres. Basta de llamadas sin contestar, ON CLICK es tu mejor aliado para que disfrutes de la pasión de futbol como debe ser.</p>
        </div>
      </div>
