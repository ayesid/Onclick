        ...
        <div class="carousel-inner">
                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <img class="img-fluid" src="img/logo-removebg-preview.png" alt=""
                                    width="100px">
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="img/1-removebg-preview.png" alt=""
                                style="height: 400px;">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
                                <h1 class="h1 text-success">Reserva tu cancha sin complicaciones </h1>
                                <h3 class="h2">Aqui encontraras todos los centros deportivos mas cercanos y con
                                    disponibilidad</h3>
                                <p>
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="img/5-removebg-preview.png" alt=""
                                style="height: 400px;">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 col-lg-3 mb-5 mb-lg-0 ">
                    ...
                    <p class="mb-4">Contamos con Canchas Sintèticas para que disfrutes con tu grupo de amigos.
                        Disponibles para alquiler por horas, torneos y eventos en general. </p>
                    <p><a href="{{ route('centroDeportivo.listar') }}" class="btn btn-primary">Reservar cancha</a>
                    </p>
                </div>
                <!-- End Column 1 -->
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-6">
                    ...
                    <p>Nuestra aplicación está diseñada para ser intuitiva y fácil de usar tanto para los usuarios que
                        reservan las canchas como para los administradores de las instalaciones</p>
                ...
                <div class="col-lg-5">
                    <div class="img-wrap">
                        <img src="img/can2.jpg" alt="Image" class="img-fluid"
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-7 mb-5 mb-lg-0">
                    <div class="imgs-grid">
                        <div class="grid grid-1"><img src="img/cancha_inicio.webp" alt="Untree.co"
                                style="width: 500px; height: 500px;"></div>
                        <div class="grid grid-2"><img src="img/2.cancha.jfif" alt="Untree.co"></div>
                        <div class="grid grid-3"><img src="img/10-Cancha.jpg" alt="Untree.co"
                                style="width: 400px; height: 300px;"></div>
                    </div>
                </div>
                <div class="col-lg-5 ps-lg-5">
                    <h2 class="section-title mb-4">"Explora nuestras instalaciones, revisa la disponibilidad en tiempo
                        real y asegura tu espacio para jugar."</h2>
                    <p>"Nuestras canchas sintéticas están ubicadas en un entorno seguro y accesible, equipadas con
                        iluminación nocturna para que puedas jugar en cualquier momento del día."</p>

                    <ul class="list-unstyled custom-list my-4">
                        <li>"Selecciona la fecha y la hora que prefieras, y reserva tu cancha en solo unos clics.
                            Recibirás una confirmación instantánea por correo electrónico."</li>
                        <li>"Tarifas competitivas y opciones de pago flexibles disponibles. ¡Reserva ahora y prepárate
                            para disfrutar de tu juego!"</li>
                        <li>"Por favor, llega a tiempo para tu reserva y asegúrate de respetar las reglas y normativas
                            de nuestras instalaciones."</li>
                        <li>"Cancelaciones y reembolsos: Consulta nuestras políticas de cancelación para obtener
                            información sobre cómo modificar o cancelar tu reserva."</li>
                    </ul>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
                    <div class="product-item-sm d-flex">
                        ...
                        <div class="pt-3">
                            <h3>Rapida</h3>
                            <p>Nuestra app está diseñada para que puedas encontrar y reservar la cancha perfecta en
                                segundos. </p>
